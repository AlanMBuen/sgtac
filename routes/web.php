...
Route::view('profile', 'profile')
    ...
    Route::get('/puestos/{puesto}', \App\Livewire\Puesto\Detalles::class)->name('puestos.detalles');
        ...
        Route::get('/tramites', \App\Livewire\Tramite\Index::class)->name('tramites.index');
        Route::get('/tramites/{tramite}', \App\Livewire\Tramite\Detalles::class)->name('tramites.detalles');
